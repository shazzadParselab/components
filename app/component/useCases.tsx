...
import { TaglineUseCaseIcon } from "./icons_libary";
...
export default function UseCasesComponent() {
  ...
  return (
    <section className="useCaseBody overflow-hidden flex items-center justify-center w-full px-5 py-12 md:py-20 lg:py-32">
