// /*
// Pending tasks:
//  --Adjusting the link button and other size
//  --Setting the background color for the links
//  --Resizing the logo or responsive
//  --Finalizing the NavLink styles
//  */
...
//   id: number;
//   title: string;
//   Source: string; //as src link
//   alternative: string; // alt string value
//   svg_visible?: boolean;
//   svg?: SVGAElement;
//   visible: boolean;
// }
...
//   {
//     id: 1,
//     title: "products Desiner",
//     Source: "/static/icon/navbar_logo.svg",
//     alternative: "products Desiner",
//     visible: true,
//   },
//   {
//     id: 2,
//     title: "products Desiner",
//     Source: "/static/icon/red_logo.png",
//     alternative: "products Desiner",
//     visible: false,
//   },
// ];
...
//     id: 1,
//     title: "Our Solutions",
//     dropdown: [{ id: 1, title: "First", hypertext: "#first" }],
//     hypertext: "#our_solution",
//   },
//   {
//     id: 2,
//     title: "Apps",
...
//     dropdown: [],
//     hypertext: "#our_success",
//   },
//   {
//     id: 4,
//     title: "Resources",
//     dropdown: [{ id: 2, title: "Second", hypertext: "#second" }],
//     hypertext: "#our_resource",
//   },
// ];

// export default function Navbar() {
//   const [navbarIcon, setNavbarIcon] = useState(icons);
//   const [navlinks, setNavLinks] = useState(navLinks);

//   return (
//     <header>
//       <nav className="pd_navbar pd_container">
//         {/*-------Home icon------*/}
//         {navbarIcon &&
//           navbarIcon.map(
//             (icon) =>
//               icon.visible && (
//                 <div key={icon.id} className="pd_home_icon">
//                   <Link prefetch="intent" to="/">
//                     <img src={icon.Source} alt={icon.alternative} />
//                   </Link>
//                 </div>
//               )
//           )}
...
//         {/*-------Home icon------*/}
//         {navlinks && (
//           <ul className="pd_navbar_links">
//             {navlinks.map((links) => (
//               <li key={links.id}>
//                 <Link to={links.hypertext} className="pd_navbar_menu_item">
//                   <p>{links.title}</p>
//                   {links && links.dropdown && links.dropdown.length > 0 && (
//                     <ChevronDown />
//                   )}
//                 </Link>
//               </li>
...
//             Free Consultation <ChevronUpRight color="white" />
//           </button>
//         </div>
//       </nav>
//     </header>
...
// // -------- Navbar Logo ----------
//   const [navbarIcon, setNavbarIcon] = useState(icons);
//   const [iconEditField, setIconEditField] = useState<{ id: number; open: boolean;}>({ id: 1, open: false });

//   const [iconBoxOpen, setIconBoxOpen] = useState<boolean>(false);
//   const [createNewIconBox, setCreateNewIconBox] = useState(false);

//   const handleLogoSelect = (id: number) => {
//     let select_logo = navbarIcon.map((icon) => ({
//       ...icon,
//       visible: icon.id === id,
//     }));
//     setNavbarIcon(select_logo);
//   };
...
//     const image = formData.get("source") as File;
//     const alt_text = formData.get("alt") as string;
//     const title = formData.get("title") as string;
//     const logo_id = formData.get("logo_id") as string;

//     if (image.name && image instanceof File) {
//       const img_url = URL.createObjectURL(image);

//       setNavbarIcon((icons) =>
//         icons.map((icon) =>
//           icon.id == Number(logo_id)
//             ? { ...icon, source: img_url, alternative: alt_text, title:title }
//             : icon
//         )
//       );
//     }
...
//         icons.map((icon) =>
//           icon.id == Number(logo_id)
//             ? { ...icon, alternative: alt_text, title:title }
//             : icon
//         )
//       );
//     }
...
//   useEffect(() => {
//     setUserType(searchParams.get("user") || "");
//   }, [searchParams]);
...
//       <nav className="pd_navbar pd_container">
//         {/*-------Home icon------*/}
//         <div className={userType === "admin" ? "admin_editor" : ""} onBlur={()=>{}}>
//           {navbarIcon &&
//             navbarIcon.map(
//               (icon) =>
//                 icon.visible && (
...
//             )}
//           {userType == "admin" && (
//             <div className="admin_editor_box">
//               <button
//                 onClick={() => {
//                   setIconBoxOpen((i) => !i);
//                 }}
...
//                             onClick={() => handleLogoSelect(icon.id)}
//                           />
//                           <button
//                             onClick={() =>
//                               setIconEditField(() => ({
//                                 id: icon.id,
//                                 open: !iconEditField.open,
//                               }))
//                             }
//                           >
//                             ✏️
//                           </button>
//                           {iconEditField.open == true &&
//                             iconEditField.id == icon.id && (
//                               <div className="icon_edit_box">
...
//                         </li>
//                       ))}
//                       <button onClick={() => setCreateNewIconBox((i) => !i)}>
//                         +
//                       </button>
//                     </ul>
//                   )}
...
//                   {createNewIconBox && (
//                     <div className="create_new_icon">
//                       <div className="admin_icon_edit_box">
//                         <form onSubmit={handleNewFormSubmit} method="post">
//                           <input
//                             type="number"
//                             name="logo_id"
//                             defaultValue={icons.length + 1}
//                             hidden
//                           />
...
//         <div className={userType == "admin"? "admin_editor" : ""}>
...
// {/* --- Card --- */}
//           <div className="pd_our_products_Card">
//             {/* container Contents */}
...
//                     <p>
//                       Create unforgettable shopping experiences with interactive
//                       tools that let your customers personalize every detail.
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                   <span>Jewelry Personalization</span>
//                 </div>
//                 <div>
//                   <ul className="feature_items">
//                     <li>3D Ring Designer</li>
//                     <li>Stone Configurator</li>
...
//               <button className="pd_button secondary">
//                 Learn More
...
//             <div className="pd_our_products_Card_buttons pd_buttons">
//               <button className="pd_button secondary">
//                 Learn More <ShareIcon color="secondary" />
//               </button>
//             </div>
//           </div>
...
// import BlogAndResource from "~/components/blogResource";
// import DesinerMarketPlace from "~/components/desinerMarketPlace";
// import Footer from "~/components/footer";
// import { ProductsDesigner } from "~/components/icons/icons_libary";
...
{% capture email_body %}
  ...
  {% else %}
    ...
    {% case delivery_method %}
        ...
        {% else %}
          Thank you for shopping with OversizedTG.com — your item is now in production. Orders are typically processed and shipped within 5–7 business days.

If you need to make changes or cancel, please contact us within 24 hours or as soon as possible, before your order enters the production queue. Once it’s queued, we may be unable to make adjustments.
      ...
      <table>
        ...
        <td class="order-list__product-description-cell">
          ...
          <span class="order-list__item-title">{{ line_title }}&nbsp;&times;&nbsp;{{ line_display }}</span><br/>
             ...
             {% if line.variant.title contains 'customization_id' %}
            {% assign line_variant_title = ' ' %}

            
          {% elsif line.variant.title contains 'inkybay_option_id' %}
            {% assign line_variant_title = ' ' %}

            
          {% else %}
            {% assign line_variant_title = line.variant.title %}
          {% endif %}

          {% if line.variant.title != 'Default Title' and is_parent == false %}
            <span class="order-list__item-variant">{{ line_variant_title }}</span><br/>
...
{% if line.variant.title contains 'customization_id' %}
  ...
  <div class="order-list__item-properties">
	...
	{% unless property.last == empty %}
        ...
        {% if property.first == '_inkybay_customization_id' %}
        {% elsif property.first == '_inkybay_same_design_items' %}
        {% elsif property.first == '_inkybay_option_id' %}
        
        
        {% elsif property.first == '_inkybay_size_quantity' %}
        <p><small>{{ property.last | replace: '*|olo.amp|*', '&' }}</small></p>
        {% elsif property.first == '_inkybay_product_color' %}
        <p><small>Color : {{ property.last }}</small></p>
        {% elsif property.first == '_inkybay_option_data' %}
      ...
      <table>
        ...
        <td class="order-list__product-description-cell">
          ...
          {% assign item_display = child_line.quantity %}
           ...
           {% if child_line.variant.title contains 'customization_id' %}
            {% assign child_line_variant_title = ' ' %}

            
          {% elsif child_line.variant.title contains 'inkybay_option_id' %}
            {% assign child_line_variant_title = ' ' %}

            
          {% else %}
            {% assign child_line_variant_title = child_line.variant.title %}
          {% endif %}

          {% if child_line.variant.title != 'Default Title'%}
            <span class="order-list__item-variant">{{ child_line_variant_title }}</span>
          {% endif %}
        </td>
      </table>
    </td>
...
//     <section>
    ...
    //               ? component_data.background_color || "transparent"
    //               : "transparent",
    //         }}
    //       >
    //         {/* Inject hover effect styles uniquely */}
    //         {component_data.component_css?.pd_main_content_card_hover_effect && (
    //           <style
    //             dangerouslySetInnerHTML={{
    //               __html: `
    //               .${component_data.component_css.pd_main_content_card_hover_effect}:hover {
    ...
    //               alt={component_data.background_image.altTitle}
    //             />
    //           )}
    ...
    //             display: "flex",
    //             flexDirection:
    //               component_data.component_css?.pd_main_contents__flex_direction ||
    //               "column",
    //           }}
    //         >
    //           <div
    ...
    //                 style={{
    //                   alignItems:
    //                     component_data.component_css?.pd_content_title__align_items ||
    //                     "flex-start",
    //                   width:
    //                     component_data.component_css?.pd_content_title__width ||
    //                     "100%",
    //                   textAlign:
    //                     component_data.component_css?.pd_content_title__text_align ||
    //                     "center",
    //                   maxWidth:
    //                     component_data.component_css?.pd_content_title__maxwidth ||
    //                     "896px",
    //                 }}
    //               >
    ...
    //                     style={{
    //                       fontSize:
    //                         component_data.component_css?.pd_content_title__font_size ||
    //                         "48px",
    //                     }}
    //                   >
    //                     {component_data.title}
    ...
    //             <div className="pd_main_content_cards">
    ...
    //                     display: "flex",
    //                     maxWidth:
    //                       component_data.component_css?.pd_main_content_card_width ||
    //                       "100%",
    //                     boxShadow:
    //                       component_data.component_css
    //                         ?.pd_main_content_card_box_shadow || "none",
    //                     alignItems:
    //                       component_data.component_css
    //                         ?.pd_main_content_card_align_items || "flex-start",
    //                     gap:
    //                       component_data.component_css?.pd_main_content_card_gap ||
    //                       "0",
    //                     padding:
    //                       component_data.component_css?.pd_main_content_card_padding ||
    //                       "0",
    //                     transition: "all 0.3s ease-in-out", // smooth default
    //                     borderRadius: "20px",
    //                     background:
    //                       component_data.component_css
    //                         ?.pd_main_content_card_background || "#fff",
    //                     border:
    //                       "1px solid " +
    //                         (component_data.component_css
